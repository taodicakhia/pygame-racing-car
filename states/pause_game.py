...
class Pause(State):
    def __init__(self, game):
        super().__init__(game)
        self.load_assets()
        self.paused_text = Text("Đã tạm dừng", y = 220, font="Constantia", font_size = 50, center_x=True, color=(255, 255, 255))
        self.resume_button = Button("Tiếp tục", 300, 550, 300, 80, btn_color=(120, 255, 120), hovered_btn_color=(46, 255, 46), border_radius=6)
        self.exit_game_button = Button("Về màn hình chính", 872, 550, 300, 80, btn_color=(255, 128, 128), hovered_btn_color=(255, 102, 102), text_color=(255, 255, 255), border_radius=6)
